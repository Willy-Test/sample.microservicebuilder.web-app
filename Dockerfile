...
RUN /bin/bash -c "/opt/ibm/wlp/usr/extension/liberty_dc/bin/config_liberty_dc.sh -slient /opt/ibm/wlp/usr/extension/liberty_dc/bin/slient_config_liberty_dc.txt"
